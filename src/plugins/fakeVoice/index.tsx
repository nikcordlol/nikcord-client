...
import { addUserAreaButton, removeUserAreaButton, UserAreaButton, UserAreaRenderProps } from "@api/UserArea";
...
function GhostContextMenu({ onClose }: { onClose: () => void; }) {
    ...
    return (
        <Menu.Menu
            ...
            aria-label="Fake Voice Configuration"
            onClose={onClose}
        >
    ...
    return (
        <UserAreaButton
            ...
            onContextMenu={(e: React.MouseEvent) =>
                ContextMenuApi.openContextMenu(e, ({ onClose }) => <GhostContextMenu onClose={onClose} />)
            }
...
export default definePlugin({
    ...
    authors: [{ name: "Niko", id: 798692960325730315n }],
